...
image::figurer\objtype_sportidrettplass.png[link=figurer\objtype_sportidrettplass.png, alt="Bilde av et eksempel på objekttypen SportIdrettPlass, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
[discrete]
====== Egenskaper
[cols="20,80"]
|===
...
image::figurer/objtype_grunnmur.png[link=figurer/objtype_grunnmur.png, alt="Bilde av et eksempel på objekttypen Grunnmur, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
[discrete]
====== Egenskaper
[cols="20,80"]
|===
...
image::figurer\objtype_ledning.png[link=figurer\objtype_ledning.png, alt="Bilde av et eksempel på objekttypen Ledning, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
[discrete]
====== Egenskaper
[cols="20,80"]
|===
...
image::figurer/objtype_parkeringsomrade.png[link=figurer/objtype_parkeringsomrade.png, alt="Bilde av et eksempel på objekttypen Parkeringsområde, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
[discrete]
====== Egenskaper
[cols="20,80"]
|===
...
*Definisjon:*  område som alle, eller en bestemt gruppe har bruksrett til 
  ...
  Merknad: Det er ofte vilkår om at den bruksrettigede må ha en eiendom av en viss størrelse. Eksempel på rettigheter er beiterett, hogstrett og fiskerett. 
