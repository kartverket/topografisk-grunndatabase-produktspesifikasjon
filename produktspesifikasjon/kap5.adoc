...
|Realisering av: 
|«ApplicationSchema» TopografiskGrunndatabase-1.0::«» Fylke +
|===
...
|Realisering av: 
|«ApplicationSchema» TopografiskGrunndatabase-1.0::«» Grense +
|===
...
|Realisering av: 
|«ApplicationSchema» TopografiskGrunndatabase-1.0::«» Kommune +
|===
...
.Oversiktsdiagram Arealdekke A-I 
image::diagrammer/Oversiktsdiagram Arealdekke A-I.png[link=diagrammer/Oversiktsdiagram Arealdekke A-I.png, Alt="Diagram med navn Oversiktsdiagram Arealdekke A-I som viser UML-klasser beskrevet i teksten nedenfor."]
 
'''
 
.Oversiktsdiagram Arealdekke K-V 
image::diagrammer/Oversiktsdiagram Arealdekke K-V.png[link=diagrammer/Oversiktsdiagram Arealdekke K-V.png, Alt="Diagram med navn Oversiktsdiagram Arealdekke K-V som viser UML-klasser beskrevet i teksten nedenfor."]
...
|Realisering av: 
|«ApplicationSchema» TopografiskGrunndatabase-1.0::«» Transformatorstasjon +
|===
