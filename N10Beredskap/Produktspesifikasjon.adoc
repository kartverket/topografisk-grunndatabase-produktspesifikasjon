...
=== Sammendrag
Topografisk grunndatabase skal dekke behovet for landsdekkende kartdata i stor målestokk. 
Hovedfokus er å danne ett grunnlag for kartdata, kartproduksjon og tilpasse datagrunlaget slik at det kan brukes for automatisk generalisering til mindre målestokker. 
