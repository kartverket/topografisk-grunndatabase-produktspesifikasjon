// Start of UML-model
=== Pakke: «ApplicationSchema» TopografiskGrunndatabase-1.0 - Utkast
...
<<jernbanestasjon,«FeatureType» Jernbanestasjon>> +
...
Eksempel:
FKB-AR5, FKB-bygning eller N50 Kartdata
...
*Merknad:*
Dette innbefatter også massetipp da arealet er vanskelig å skille fotogrammetrisk fra massedeponi
...
|===
|*Navn:* 
|*registrertimatrikkelen*
 
|Definisjon: 
|boolsk egenskap som forteller om bygningen er registrert i matrikkelen eller ikke
...
|Definisjon: 
|Hentes fra matrikkel

En entydig identifikasjon av bygningen. Bygningsnumrene er unike på landsbasis, og tildeles automatisk.
...
|===
|*Navn:* 
|*Hvis bygning er registrert i matrikkelen er egenskapene bygningsnummer og bygningstype påkrevd*
 
|Beskrivelse: 
|Hvis egenskapen registrertimatrikkelen er JA er følgende påkrevd
1. bygningsnummer må hentes fra matrikkel
2. bygningstype må hentes fra matrikkel
...
|Type: 
|<<høydekurvetype,«CodeList» Høydekurvetype>>
|Profilparametre i tagged values: 
|
...
|Profilparametre i tagged values: 
|
SOSI_navn: NAVNEOBJEKTHOVEDGRUPPE + 
|===
[cols="20,80"]
|===
|*Navn:* 
